  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-start justify-between mb-6 gap-4 flex-wrap">
        <div>
          <h1 className="text-xl font-bold text-slate-800">{inquiry.organizationName}</h1>
          <p className="text-sm text-slate-500 mt-1">
            {inquiry.contactPerson} &middot; {inquiry.email}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6">
            ...
            <dl>
              <DetailRow label="Organization" value={inquiry.organizationName} />
              <DetailRow label="Contact Person" value={inquiry.contactPerson} />
          ...
          <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6">
            ...
            <dl>
              <DetailRow label="Sponsorship Interest" value={inquiry.sponsorshipInterest} />
